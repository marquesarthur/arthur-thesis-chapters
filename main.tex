...
\input{sections/cp1-outline}

\input{sections/cp2-outline}

\input{sections/cp3-outline}

% \input{sections/cp4-outline}
% \input{sections/cp5-outline}
% \input{sections/cp6-outline}



\input{sections/cp7-outline}

% \input{sections/cp8-outline}
...
% \input{appendix/appendix-cp3}
% \input{appendix/appendix-cp4}
% \input{appendix/appendix-cp6}
