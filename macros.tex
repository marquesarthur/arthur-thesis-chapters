...
\newcommand{\code}[1]{{\fontsize{8}{1}\usefont{OT1}{pcr}{m}{n}\selectfont\color{color_29791} \hl{#1}}}
...
\DeclareFixedFont{\ttb}{T1}{txtt}{bx}{n}{7.5} % for bold
\DeclareFixedFont{\ttm}{T1}{txtt}{m}{n}{7.5}  % for normal
