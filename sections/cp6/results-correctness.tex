...
\rev{To assess the quality of each participant's solution}, 
...
Comparing the correctness scores for each individual task, we observe \rev{more variability}
in the scores of 
the \texttt{distances} task for participants with tool support. 
Among potential reasons for \rev{some of} the lower scores, we believe that the text automatically identified 
