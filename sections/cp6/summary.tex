...
Results from this experiment indicate that, when the semantic-based approach applied by the tool identifies much of the text that humans deem relevant to a task, participants were able to produce solutions more correct than the ones from participants without the tool. \gcm{But only for one task...}
