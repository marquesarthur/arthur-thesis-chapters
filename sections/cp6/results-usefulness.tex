...
We also obtained written feedback from 19 out of the 24 participants. This was divided on feedback of the tasks (24 data points)
...
% On the other hand, 45\% of the responses of 
...
% ``\textit{I noticed that the highlights were particularly helpful on pages where I am familiar with the page structure, like Stack Overflow.
% There, the highlight helped me quickly determine which parts of the page to ignore.}''
