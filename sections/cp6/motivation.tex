...
with the tool than without, there is a chance that the text shown by \acs{tool} is not \textit{useful}. \rev{That is, the text does not have information that helps a developer in completing the task at hand, or }
