...
\art{I'll have the figure here while I improve the text. Will worry about formatting later :)}
...
% \footnote{\url{https://github.com/k9mail/k-9/pull/1755}}
...
% \begin{figure}
%     \centering
%     \includegraphics[width=\dimexpr\linewidth-4\fboxsep-2\fboxrule]{cp1/action-builder.png}
%     \caption{Snapshot of the official Android notifications API overview}
%     % \label{fig:android-notification-action}
% \end{figure}


% a tutorial covers several topics, out of which only some
%  might be of relevance to a developer's task. 
% However, even within a  



%  Reading all of its content would take approximately 
...
%  has information about both the
