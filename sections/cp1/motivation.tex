...
\begin{figure}
    ...
    \caption{Snapshot of the official Android notifications tutorial  with text highlights relevant to the GitHub issue \#1741}
...
As a learning resource written for a large audience, tutorials often contain a series of structure topics 
...
\begin{figure}
    ...
    \caption{Snapshot of the Android Notification.Action API reference documentation with text highlights relevant to the GitHub issue \#1741}
...
about android notifications in Figure~\ref{fig:android-search-results}
is a post in a \acf{qa} web page from Stack Overflow\footnote{\url{https://stackoverflow.com/}}.
...
\begin{figure}
    ...
    \caption{Snapshot of a Stack Overflow question about Android notifications  with text highlights relevant to the GitHub issue \#1741}
