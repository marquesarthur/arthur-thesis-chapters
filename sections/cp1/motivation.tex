...
when incorporating a new software library needed for a new feature, a developer might consult official application programming interface (API) documents for the library~\cite{robillard2011field, umarji2008archetypal} or 
 ...
 %for functionality, security and performance-related topics
 ~\cite{parnin2012, silva2019}.



Many of the artifacts that developers consult
contain unstructured text; for the purposes of this thesis, \wee refer to artifacts with unstructured text as natural language artifacts.  
...
\gcm{how does this reference support the statement?}
...
\gcm{This is a bit of an odd desription of an API - suggest using something more
standard.}
