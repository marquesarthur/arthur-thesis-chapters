...
% Hence, a developer would have to use several tools to encompass all the artifact 
% types that they use to store information.
...
As an alternative to using several artifact-specific tools that assist in finding information in certain kinds of artifacts, we could also consider 
...
% Moreover, deploying the right technique is also challenging because developers 
% assessing certain artifact may have different
% information needs than anticipated by techniques~\cite{saracevic1975}.
