...
\begin{itemize}
    ...
    \acs{tool} assists a software developer while they work on a task. 
\end{itemize}
...
\begin{itemize}
    ...
    \item \acs{DS-python} contains three Python tasks and it includes annotations from 24 participants that indicated what text assisted them in writing each task's solution.
\end{itemize}