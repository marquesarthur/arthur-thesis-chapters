...
% , whose approach aimed to classify the content of development emails in six categories, such as \textit{`solution proposal'} and \textit{`problem discovery`}. Let's consider the following two sentences
