...
\marginpar{{\small
\art{I'm not sure about the structure. This could be a section instead of a subsection?}
}}
...
frequency of co-occurrence of words (or phrases) in natural language artifacts, also referred to as \textit{documents}. 
...
Techniques able to infer the semantics of text are of interest to us and thus, we further detail core concepts related to them. 
