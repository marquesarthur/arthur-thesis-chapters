...
\art{I may need an implementation section to state that I validated these features/properties in the \acs{DS-synthetic} corpus}

\subsection{Approach Overview}


\red{should appear at the star of the section even if I do a top-down description later on}
