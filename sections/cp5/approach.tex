...
Following these procedures, we take a fully trained model and we compute the relevance of a sentence $a_i \in A$ when we pair it to to a vector that represents all the sentences in a task $T$.
