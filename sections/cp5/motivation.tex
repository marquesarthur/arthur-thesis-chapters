...
words (or terms) also present in a task description is likely relevant to the developer's task. However, direct matches are often scarce \red{ref} and several researchers have observed that:
