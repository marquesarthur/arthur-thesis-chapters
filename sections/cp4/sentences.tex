...
\art{I am mostly trying to give a sense of the content of each artifact type}
...
Table~\ref{tbl:corpus-data-structure}. \gm{Need to move table up so it is Table 4.3}
...
\red{TODO: No bar graphs, mostly only tables}

\red{TODO: break analysis per type of task: GitHub and Stack Overflow}

\red{TODO: Analysis should justify if data can be threated homogeneously}
