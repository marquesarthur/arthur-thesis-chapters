...
\rev{Table~\ref{tbl:corpus-annotation-overlap} summarizes the amount of overlap between annotators' responses.}
Out of \red{n}
unique marked
sentences, 
...
We use a Wilcoxon-Mann-Whitney test~\cite{mannWhitneyU} to check if differences in the results are statistically significant.
In case of differences, we also compute effect size~\cite{grissom2005effect}.
}
