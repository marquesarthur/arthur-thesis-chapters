...
These sentences comprise natural language written text---in this case, English---
and do not consider source code snippets that appear alongside the text.}
...
and, beyond code snippets and a minimal number of structured fields, the 
...
\art{I tried to open the section showing and example of the data in the corpus}
