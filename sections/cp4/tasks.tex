...
functionality, security and performance-related improvements~\cite{Li2018android, Mateus2020}, what impact its development community~\cite{linares2014, bavota2014b, mcdonnell2013}
and, among other reasons, is a likely cause for why 
over 35,000 developers have used Q\&A forums to discuss tasks covering 87\% of the classes in the Android API~\cite{parnin2012}.}
...
\red{We then randomly selected 25 distinct issues originating from these starred projects as the GitHub tasks of our corpus.}
...
We randomly select \red{25} Stack Overflow posts from a curated list about Android development~\cite{baltes2020}.
