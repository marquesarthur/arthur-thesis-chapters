...
\gm{We}
%That is, our corpus creation pipeline
...
We consider a task's title (i.e., SO \gm{I don't think you have introduced
this short form?} question or GitHub issue title) as the seed used to search artifacts
using the \texttt{googlesearch} API~\cite{googlesearch}. \gm{Seems like
