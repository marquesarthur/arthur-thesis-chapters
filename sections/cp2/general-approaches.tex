...
\acf{IR} comprises \rev{the structure, analysis, storage, search, and retrieval of information~\cite{salton1983}. This definition encompasses }
techniques
and approaches for finding entities 
that satisfy an information need (documents, paragraphs, sentences, etc.)~\cite{manning2010IR}.


\rev{\acs{IR} research has many sub-fields~\cite{zhang2016, liu2019data, tamine2010}, including
...
These research sub-fields often intersect with other fields, such as \acf{NLP}, \acf{ML}, or \acf{DL}, and given the wide scope of  \acs{IR} research, this section focuses on early concepts associated with search-related  \acs{IR}. We discusse IR efforts in other fronts in subsequent sections of this chapter. } 
