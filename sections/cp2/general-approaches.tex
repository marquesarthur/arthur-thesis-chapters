...
to assists developers in finding information useful to 
...
and such analyses might assist in the automatic identification of text that satisfies some information need. 
...
neural network architectures are composed by several layers 
