...
\rev{
Among these sub-fields, the work in this thesis is closer to contextual retrieval, where multiple attributes model context, such as a user's intentions, tasks, needs, and the environment in which information activities occur~\cite{dourish2004we}. For example, a context-aware \acs{IR} system could provide different results 
