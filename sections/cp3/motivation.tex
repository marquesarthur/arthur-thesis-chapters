...
\rev{Our goal is to identify common properties of task-relevant information found across different types of artifacts which might lead to the design of a more generalizable approach for automatically identifying task-relevant text.
Such an approach might be able to address the limitations 
of the existing artifact-specific approaches presented in Chapter~\ref{ch:related-work}. }Particularly, we consider three questions:
