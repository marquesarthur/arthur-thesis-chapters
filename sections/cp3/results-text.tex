...
We used a Wilcoxon signed-rank test~\cite{wohlin2012} \rev{to test whether certain frames appear more often in the text highlighted by the participants.
Results show that} both individual frames and pairs of frames 
