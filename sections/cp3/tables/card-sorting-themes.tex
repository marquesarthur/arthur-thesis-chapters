...
& \parbox[l][1.1cm][c]{3cm}{\cellcolor{lightgray} skimming} 
& \parbox[l][1.1cm][c]{12cm}{\cellcolor{lightgray} The act of quickly reading a portion of a document to locate relevant text. It also represents the act of scrolling from a document's sections and deciding to stop at certain points}
