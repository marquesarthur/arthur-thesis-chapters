...
\gm{Developing techniques that can automatically identify text
...
\gm{As we have described earlier in this thesis, while there
...
\gm{We then gather task-relevant sentences from these artifacts
from human experts.}
...
\gm{Does the figure need updating?}
